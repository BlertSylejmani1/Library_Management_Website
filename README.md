...
#Ky projekt është një aplikacion web për menaxhimin e librarisë, i ndërtuar duke përdorur ReactJS për frontend dhe PHP & MySQL për backend.
...
#Në fazë e parë është ndërtuar struktura bazë e aplikacionit duke përdorur PHP dhe OOP, me të dhëna të simuluara (arrays).
