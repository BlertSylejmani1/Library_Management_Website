...
$stylePath = APP_ROOT . '/assets/css/style.css';
$styleVersion = file_exists($stylePath) ? (string) filemtime($stylePath) : APP_VERSION;
?>
<!DOCTYPE html>
...
<head>
    ...
    <link rel="stylesheet" href="<?= BASE_URL ?>/assets/css/style.css?v=<?= h($styleVersion) ?>" />
</head>
